...
public class LinearBoardView extends LinearLayout implements AutoScroller.AutoScrollListener {
    ...
    public LinearBoardView(Context context) {
        super(context);
    }

    public LinearBoardView(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(attrs);
    }

    public LinearBoardView(Context context, AttributeSet attrs, int defStyleAttr) {
